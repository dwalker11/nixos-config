...
# Colors
bg=$(get_tmux_option "@tmux-dotbar-bg" '#322931')
fg=$(get_tmux_option "@tmux-dotbar-fg" '#b9b5b8')
fg_current=$(get_tmux_option "@tmux-dotbar-fg-current" '#ffffff')
fg_session=$(get_tmux_option "@tmux-dotbar-fg-session" '#b9b5b8')
fg_prefix=$(get_tmux_option "@tmux-dotbar-fg-prefix" '#8fc13e')
